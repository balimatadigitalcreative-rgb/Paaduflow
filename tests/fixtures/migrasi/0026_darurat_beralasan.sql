...
-- Up Migration
-- paadu:allow-breaking Kolom ini tidak pernah dibaca kode mana pun; ditambahkan
-- keliru di 0019 dan tidak ada satu pun kueri yang menyebutnya.
ALTER TABLE customers DROP COLUMN salah_ketik;
